...
function SearchResultsPredictiveArticles({
  ...
  return (
    <div className="predictive-search-result" key="articles">
      <h5>{t('skeleton.search.results.articles')}</h5>
      <ul>
...
function SearchResultsPredictiveCollections({
  ...
  return (
    <div className="predictive-search-result" key="collections">
      <h5>{t('skeleton.search.results.collections')}</h5>
      <ul>
...
function SearchResultsPredictivePages({
  ...
  return (
    <div className="predictive-search-result" key="pages">
      <h5>{t('skeleton.search.results.pages')}</h5>
      <ul>
        {pages.map((page) => {
...
function SearchResultsPredictiveProducts({
  ...
  return (
    <div className="predictive-search-result" key="products">
      <h5>{t('skeleton.search.results.products')}</h5>
      <ul>
...
function SearchResultsPredictiveEmpty({
  ...
  return (
    <p>
      {t('skeleton.search.noResults', {term: term.current})}
    </p>
  );
}
